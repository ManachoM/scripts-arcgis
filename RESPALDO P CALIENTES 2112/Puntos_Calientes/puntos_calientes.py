# -*- coding: cp1252 -*-
#"C:\\Python27\\ArcGIS10.3\\python.exe" "C:\\Users\\Administrador\\Documents\\Piloto_IF\\Codigos Python\Script - copia2.py"
...
zip_viirs = os.path.join(CARPETA_DESCARGAS, 'VNP14IMGTDL_NRT_South_America_24h.zip')
...
VNP14IMGTDL_NRT_South_America_24h_shp = os.path.join(CARPETA_DESCARGAS, "VNP14IMGTDL_NRT_South_America_24h.shp")
...
# Process: Eliminar
arcpy.Delete_management(VNP14IMGTDL_NRT_South_America_24h_shp, "ShapeFile")
...
url = 'https://firms.modaps.eosdis.nasa.gov/data/active_fire/viirs/shapes/zips/VNP14IMGTDL_NRT_South_America_24h.zip'
viirs_content = requests.get(url)
...
#########################
## Antiguo metodo:
### zipdescargado = 'C:\Users\Administrador\Downloads\VNP14IMGTDL_NRT_South_America_24h.zip'
### datosdescomprimidos = 'C:\Users\Administrador\Documents\Piloto_IF\Datos Descargados'
### descarga = webbrowser.open("https://firms.modaps.eosdis.nasa.gov/data/active_fire/viirs/shapes/zips/VNP14IMGTDL_NRT_South_America_24h.zip", new=2, autoraise=True)
