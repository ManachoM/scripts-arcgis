...
# La actualizacion de puntos calientes se aplican a los feature class:
## puntos_salientes_dia
## puntos_calientes_a_la_fecha

# Se utilizan localmente los archivos (se crean y eliminan en el proceso):
## IF_Chile_shp = IF_Chile.shp utilizado para actualizar puntos_calientes_dia
## IF_Chile_Acum_shp = IF_Chile_Acum.shp utilizado para actualizar puntos_calientes_a_la_fecha

#------------------------------------------------------------------------------------------------------------------

# Ruta de GDB y feature classes utilizados
...
#puntos_calientes_sde_puntos_calientes_dia = "C:\Users\claud\Desktop\geproc onemi\script_bd\Puntos_Calientes\puntos_calientes.gdb\puntos_calientes_dia"
#puntos_calientes_sde_puntos_calientes_a_la_fecha = "C:\Users\claud\Desktop\geproc onemi\script_bd\Puntos_Calientes\puntos_calientes.gdb\puntos_calientes_a_la_fecha"

# Directorio de carpetas utulizadas
CARPETA_BASE = "E:\\scripts-arcgis\\Puntos_Calientes\\Piloto_IF"
#CARPETA_BASE = "C:\Users\claud\Desktop\geproc onemi\script_bd\Puntos_Calientes\Piloto_IF"
...
# Directorio Viirs continental
zip_viirs = os.path.join(CARPETA_DESCARGAS, 'J1_VIIRS_C2_South_America_24h.zip')

# Declaracion de feature class utilizadas en procesos intermedios
...
# Shp Objetivo para actualizar feature class en GDB
IF_Chile_shp = os.path.join(CARPETA_RESULTADO, "IF_Chile.shp")

# Declaracion de feature class obtenidos en procesos intermedios
...
# Declaracion de viirs continental obtenido de archivo zip [L44]
J1_VIIRS_C2_South_America_24h_shp = os.path.join(CARPETA_DESCARGAS, "J1_VIIRS_C2_South_America_24h.shp")

# Declaracion de DPA utilizado como molde en proceso de recorte
dpa_shp = os.path.join(CARPETA_DPA, "dpa.shp")

# Declaracion de capas utilizadas localmente en procesos intermedios
...
arcpy.Intersect_analysis([dpa_shp,Buffer_shp], Intersecar_shp)
...
# Process: Agregar atributos de geometria
...
# 9.) Process: Add Field - fecha formato str
arcpy.AddField_management(Disolver_shp, "fecha_str", "TEXT", "", "", "", "", "NULLABLE", "NON_REQUIRED", "")

# Process: Calculate Field
arcpy.CalculateField_management(Disolver_shp, 'fecha_str', 'cambioFecha(!Fecha!)', 'PYTHON_9.3', 'def cambioFecha(a):\n    return str(a)')
print "Calculo de la fecha en formato string realizado"

# 10.) Copia resultado
# Process: Copiar entidades
arcpy.CopyFeatures_management(Disolver_shp, IF_Chile_shp, "", "0", "0", "0")

# 11.) Incorpora resultado acum
# Process: Append
"""
field_mapping_text = Template(
...
# Crear plantilla con campo fecha_str
field_mapping_text = Template(
    "comuna \"comuna\" true false false 30 Text 0 0 ,First,#,$if_chile_path,comuna,-1,-1;provincia \"provincia\" true false false 30 Text 0 0 ,First,#,$if_chile_path,provincia,-1,-1;region \"region\" true false false 50 Text 0 0 ,First,#,$if_chile_path,region,-1,-1;AREA_GEO \"AREA_GEO\" true false false 19 Double 0 0 ,First,#,$if_chile_path,AREA_GEO,-1,-1;FECHA \"FECHA\" true true false 8 Date 0 0 ,First,#,$if_chile_path,Fecha,-1,-1;fecha_str \"fecha_str\" true true false 50 Text 0 0 ,First,#,$if_chile_path,fecha_str,-1,-1"
).substitute(if_chile_path=IF_Chile_shp)
...
"""
arcpy.Intersect_analysis([Buffer_dia_shp,dpa_shp], Intersecar_dia_shp)
...
print "Calculo del area en hectareas dia realizado"

# Process: Add Field - fecha formato date
...
print "Calculo de la fecha dia realizado"

# Process: Add Field - fecha formato str
arcpy.AddField_management(Disolver_dia_shp, "fecha_str", "TEXT", "", "", "", "", "NULLABLE", "NON_REQUIRED", "")

# Process: Calculate Field
arcpy.CalculateField_management(Disolver_dia_shp, 'fecha_str', 'cambioFecha(!Fecha!)', 'PYTHON_9.3', 'def cambioFecha(a):\n    return str(a)')
print "Calculo de la fecha en formato string realizado"
...
# Crear plantilla con campo fecha_str
field_mapping_text = Template(
        "comuna \"comuna\" true true false 30 Text 0 0 ,First,#,$path_disolver_dia,comuna,-1,-1;provincia \"provincia\" true true false 30 Text 0 0 ,First,#,$path_disolver_dia,provincia,-1,-1;region \"region\" true true false 50 Text 0 0 ,First,#,$path_disolver_dia,region,-1,-1;area_geo \"area_geo\" true true false 8 Double 8 38 ,First,#,$path_disolver_dia,AREA_GEO,-1,-1;fecha \"fecha\" true true false 36 Date 0 0 ,First,#,$path_disolver_dia,Fecha,-1,-1;fecha_str \"fecha_str\" true true false 50 Text 0 0 ,First,#,$path_disolver_dia,fecha_str,-1,-1;GlobalID \"GlobalID\" false false false 38 GlobalID 0 0 ,First,#;st_area(shape) \"st_area(shape)\" false false true 0 Double 0 0 ,First,#;st_length(shape) \"st_length(shape)\" false false true 0 Double 0 0 ,First,#"
).substitute(path_disolver_dia=Disolver_dia_shp)
...
# Se genera plantilla considerando el campo fecha_str
field_mapping_text = Template(
    "comuna \"comuna\" true true false 30 Text 0 0 ,First,#,$path_if,comuna,-1,-1;provincia \"provincia\" true true false 30 Text 0 0 ,First,#,$path_if,provincia,-1,-1;region \"region\" true true false 50 Text 0 0 ,First,#,$path_if,region,-1,-1;area_geo \"area_geo\" true true false 8 Double 8 38 ,First,#,$path_if,AREA_GEO,-1,-1;fecha \"fecha\" true true false 36 Date 0 0 ,First,#,$path_if,Fecha,-1,-1;fecha_str \"fecha_str\" true true false 50 Text 0 0 ,First,#,$path_if,fecha_str,-1,-1;GlobalID \"GlobalID\" false false false 38 GlobalID 0 0 ,First,#;st_area(shape) \"st_area(shape)\" false false true 0 Double 0 0 ,First,#;st_length(shape) \"st_length(shape)\" false false true 0 Double 0 0 ,First,#"
).substitute(path_if=IF_Chile_shp)
